...
def get_number(prompt, low, high):
    while True:
        try:
            ...
            if number > low and number <= high: return number
            else: print(f"Entry must be greater than {low} and less than or equal to {high}.")
        except ValueError: print("value was not a number, try again")
...
def get_integer(prompt, low, high):
    while True:
        try:
            ...
            print("Number was not an integer, Try again")
